# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-03 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='A label for URL config', max_length=61, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.SlugField(max_length=31, unique=True)),
                ('slug', models.SlugField(help_text='A label for URL config', max_length=61, unique=True)),
            ],
            options={
                'ordering': ['name'],
